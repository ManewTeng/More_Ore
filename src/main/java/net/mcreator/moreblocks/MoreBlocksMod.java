...
import net.mcreator.moreblocks.init.MoreBlocksModEnchantments;
import net.mcreator.moreblocks.init.MoreBlocksModBlocks;
import net.mcreator.moreblocks.init.MoreBlocksModBiomes;
...
public class MoreBlocksMod {
	public static final Logger LOGGER = LogManager.getLogger(MoreBlocksMod.class);
	...
	public MoreBlocksMod() {
		...
		MoreBlocksModFeatures.REGISTRY.register(bus);
		MoreBlocksModPaintings.REGISTRY.register(bus);

		MoreBlocksModEnchantments.REGISTRY.register(bus);

		MoreBlocksModBiomes.REGISTRY.register(bus);
